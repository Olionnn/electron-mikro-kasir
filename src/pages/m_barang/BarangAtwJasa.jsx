        ...
        <div className="w-full lg:w-[60%] flex flex-col overflow-hidden bg-white border-r">
          ...
          <div className="w-full lg:w-[40%] overflow-y-auto p-4 lg:p-6 bg-gray-50">
            ...
            <div className="flex items-center gap-4">
              ...
              <button onClick={() => alert("Mau Hapus Items?")} className="inline-flex items-center gap-2 bg-white border border-red-500 text-red-700 px-3 py-2 rounded-lg hover:bg-green-50">
                <VscTrash size={18} />
              </button>
