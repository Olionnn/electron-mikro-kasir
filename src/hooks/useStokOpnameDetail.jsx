...
const stokopnamedetailIpc = {
  getList: (params) => window.electronAPI.getStokOpnameDetailList(params),
  getById: (id) => window.electronAPI.getStokOpnameDetailById(id),
  create: (data) => window.electronAPI.createStokOpnameDetail(data),
  update: (id, data) => window.electronAPI.updateStokOpnameDetail( id, data ),
  remove: (id) => window.electronAPI.deleteStokOpnameDetail(id),
};
